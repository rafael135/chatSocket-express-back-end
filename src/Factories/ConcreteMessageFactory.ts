...
class ConcreteMessageFactory implements AbstractMessageFactory {
    public async createGroupMessage(fromUserUuid: string, toUuid: string, body: string, type: MessageType, imageUuid: string | null): Promise<GroupMessageInstance> {
    ...
    public async createUserMessage(fromUserUuid: string, toUuid: string, body: string, type: MessageType, imageUuid: string | null): Promise<UserMessageInstance> {
